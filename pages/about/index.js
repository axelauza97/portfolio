...
function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About Axel Auza</title>
        <meta
          name="description"
          content="Background, education, thesis work, and contact details for Axel Auza, a full stack developer based in Guayaquil, Ecuador."
        />
        <meta property="og:title" content="About Axel Auza" />
        <meta
          property="og:description"
          content="Background, education, thesis work, and contact details for Axel Auza."
        />
        <meta property="og:type" content="profile" />
        <meta property="og:url" content="https://axelauza.com/about" />
        <meta property="og:image" content="https://axelauza.com/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Axel Auza" />
        <meta
          name="twitter:description"
          content="Background, education, thesis work, and contact details for Axel Auza."
        />
        <link rel="canonical" href="https://axelauza.com/about" />
      </Head>
      ...
      <section className={classes.main}>
        ...
        <article className={classes.grid_main}>
          ...
          <section className={`${classes.contact}  ${classes.reveal}`}>
            ...
            <p>
              For any questions or information, send a mail and I&apos;ll get in
              touch.
            </p>
        ...
        <section className={`${classes.degree} ${classes.reveal}`}>
          ...
          <div className={classes.university}>
            <p>
              ...
              conditions. <br /> On left side is the rgb channels and right
              side thermal channel colored.
            </p>
            <div className={classes.button}>
              <Button
                onClick={() =>
