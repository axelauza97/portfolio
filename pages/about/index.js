    ...
    <section className={classes.main}>
      ...
      <article className={classes.grid_main}>
        <section className={classes.about}>
          ...
          <p>
            My professional goal is to deliver well structure code that makes people life easier or
            speed up tasks, also I like to improve my abilities everyday pushing myself in new
            projects.
          </p>
        </section>
        ...
        <section className={`${classes.contact}  ${classes.reveal}`}>
          ...
          <p>For any questions or information, send a mail and I'll get in touch.</p>
          <div>axelauza97@hotmail.com</div>
          <div className={classes.button}>
            <Button onClick={() => setShowModal((prev) => !prev)}>Send Email</Button>
          </div>
        </section>
        <section className={`${classes.open} ${classes.reveal}`}>
          <h3 className={classes.title}>Open to work</h3>
          <p>I'm looking for a job currently, If you see me as a good candidate, check my CV</p>
          <div className={classes.button}>
            <Button
              onClick={() =>
                window.open(
      ...
      <section className={`${classes.degree} ${classes.reveal}`}>
        ...
        <div className={classes.university}>
          <p>
            I made a modification to YOLOv4 to make it learn in from a new channel called "Thermal"
            for enchance detection on low lights conditions. <br /> On left side is the rgb channels
            and right side thermal channel colored.
          </p>
          <div className={classes.button}>
            <Button
              onClick={() =>
